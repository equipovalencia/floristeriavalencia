        ...
        <header>
            ...
            <nav className="bg-white border-gray-200 dark:bg-gray-900">
                <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl p-4">
                    ...
                    <Link to="/" className="mb-1 flex items-center space-x-1 rtl:space-x-reverse">
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-flower1 text-xl text-gray-700 dark:text-white mr-5" viewBox="0 0 16 16">
                        ...
                        <span className="self-center text-2xl font-bold whitespace-nowrap dark:text-white">Valencia</span>
                    </Link>
